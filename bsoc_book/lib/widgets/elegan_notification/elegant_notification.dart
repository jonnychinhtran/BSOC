...
import 'package:bsoc_book/widgets/elegan_notification/resources/arrays.dart';
import 'package:bsoc_book/widgets/elegan_notification/resources/colors.dart';
import 'package:bsoc_book/widgets/elegan_notification/resources/constants.dart';
import 'package:bsoc_book/widgets/elegan_notification/resources/extensions.dart';
import 'package:bsoc_book/widgets/elegan_notification/widgets/animated_progress_bar.dart';
import 'package:bsoc_book/widgets/elegan_notification/widgets/toast_content.dart';
      ...
      builder: (context) {
        return SafeArea(
          child: AlertDialog(
            ...
            insetPadding:
                const EdgeInsets.only(top: 60, right: 10), //custom by HoangCV
            elevation: 0,
            content: this,
          ),
        );
